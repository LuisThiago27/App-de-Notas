...
import { adicionaNotas, atualizaNotas, removeNotas } from "../servicos/Notas"
...
export default function NotaEditor({mostraNotas, notaSelecionada, setNotaSelecionada}) {
  ...
  async function deletaNota() {
    await removeNotas(notaSelecionada)
    mostraNotas()
    limpaNota()
  }
